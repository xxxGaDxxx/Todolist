...
test('correct todolist should be removed', () => {
    ...
    const endState = todolistReducer(startState, deleteTodolistAC({todolistId: todolistID_1}))
...
test('correct todolist should change its name', () => {
    ...
    const endState = todolistReducer(startState, newTitleTodolistAC({
...
test('correct filter of todolist should be changed', () => {
    ...
    const endState = todolistReducer(startState, changeFilterAC({todolistId: todolistID_2, newFilter}))
